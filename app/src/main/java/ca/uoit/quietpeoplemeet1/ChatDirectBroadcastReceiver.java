...
public class ChatDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public ChatDirectBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel,
